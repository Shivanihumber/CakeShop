	...
	public partial class frmOrderCake : Form
    {
      ...
      private void btnReset_Click(object sender, EventArgs e)
        ...
        private void radTraditional_CheckedChanged(object sender, EventArgs e)
        {
			...
			if (lstChooseCake.SelectedIndex < 0)
				lstChooseCake.SelectedIndex = 0;
		...
		private void lstChooseCake_SelectedIndexChanged(object sender, EventArgs e)
		{
			//lstChooseCake. == "Strawberry Cheese Cake";
		}
	}
}
